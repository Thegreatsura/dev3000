// lucide-react v1 removed brand icons (Github, etc.) for trademark reasons, so we
// ship the GitHub mark ourselves. Mirrors the lucide icon API (className passthrough).
